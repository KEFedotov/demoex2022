...
- Stratum: 4
- Source: 3.3.3.1 # тут любой из адресов ISP, включая localhost
...
- Source: 3.3.3.1 # технически тут может быть любой из адресов ISP
...
Таеже не должен возвращать ошибкeу
...
- Leap Indicator: 0(no warning)
- Stratum: 5 
- Source: 4.4.4.1 # технически тут может быть любой из адресов ISP

### Интерпретация

Если все ответы соответствую -> **A3.O20 PASSED**
...
- Server Role: ... (Reliable Time Service)

### Интерпретация

Если ответ соответствею -> **A3.O21 PASSED**
...
## A3.O25 SRV: Контроль доступа к iSCSI
...
ищем
    ...
    InitiatorIds : {IPAddress:192.168.100.100}

### Интерпретация

Если все ответы соответствую -> **A3.O25 PASSED**

В любом другом случае -> **A3.O25 FAILED**

## A3.O26 WEB-L: Подключение диска iSCSI
...
Если все ответы соответствую -> **A3.O26 PASSED**

В любом другом случае -> **A3.O26 FAILED**
    
## A3.O27 WEB-L: Разметка ФС подключенного диска
