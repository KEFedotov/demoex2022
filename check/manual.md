...
## A3.O17 ISP: Сервер времени развернут
...
Если оба ответа соответствуют -> **A3.O17 PASSED**

В любом другом случае -> **A3.O17 FAILED**

## A3.O18 CLI: Сервер времени ISP используется
...
- Страта: 5
- Источник: 3.3.3.1 # технически тут может быть любой из адресов ISP

### Интерпретация

Если оба ответа соответствуют -> **A3.O18 PASSED**

В любом другом случае -> **A3.O18 FAILED**

## A3.O19 SRV: Сервер времени развернут
...
Таеже не должен возвращать ошибку

### Интерпретация

Если ответ соответствует -> **A3.O19 PASSED**

В любом другом случае -> **A3.O19 FAILED**

## A3.O20 SRV: Синхронизация с ISP
...
- Страта: 5 
- Источник: 4.4.4.1 # технически тут может быть любой из адресов ISP

### Интерпретация

Если оба ответа соответствую -> **A3.O20 PASSED**

В любом другом случае -> **A3.O20 FAILED**

## A3.O21 SRV: Разрешение на синхронизацию
...
Если оба ответа соответствую -> **A3.O21 PASSED**

В любом другом случае -> **A3.O21 FAILED**

## A3.O22 RTR-R: Синхронизация с SRV

    # show ntp status

Ищем

- stratum 6, reference is 192.168.100.200 # IP SRV

### Интерпретация

Если оба ответа соответствую -> **A3.O22 PASSED**

В любом другом случае -> **A3.O22 FAILED**

## A3.O23 WEB-L: Синхронизация с SRV

    # cronyc tracking

Ищем

- reference ID: ... srv.int.demo.wsr или 192.168.100.200 # Имя или адрес SRV
- Stratum: 6
- Leap status: normal

### Интерпретация

Если все ответы соответствую -> **A3.O23 PASSED**

В любом другом случае -> **A3.O23 FAILED**

## A3.O24 SRV: iSCSI-Target
...
- ComputerName : srv
- LunMappings : {TargetName: <name>;VHD:"...vhdx"...} # Если диск не прикручен будет ответ {}
- TargetName : <name>

### Интерпретация

Если все ответы соответствую -> **A3.O24 PASSED**

В любом другом случае -> **A3.O24 FAILED**
...
### O10 Настройка NTP (второй уровень)
...
- Страта: 5
- Источник: 4.4.4.1 // ТЕхнически тут может быть любой адрес ISP
...
- reference ID: ... isp.demo.wsr или 4.4.4.1 //ТЕхнически тут может быть любой адрес ISP
- Stratum: 5
- Leap status: normal

### Интерпретация

Если все ответы соответствуют -> **C1.10 PASSED**

В любом другом случае -> **C1.10 FAILED**

### O11 CLI синхронизирует время с ISP
...
- Страта: 5
- Источник: 3.3.3.1 // ТЕхнически тут может быть любой адрес ISP

### Интерпретация

Если все ответы соответствуют -> **C1.11 PASSED**

В любом другом случае -> **C1.11 FAILED**

### O12 Внутренние машины синхронизируют время с SRV

Проверка на WEB-L, WEB-R, RTR-L, RTR-R
...
- Страта: 6
- Источник: 192.168.100.200 // Возможно отображение srv.int.demo.wsr
...
- reference ID: ... srv.int.demo.wsr или 192.168.100.200 
- Stratum: 6
- Leap status: normal
...
- stratum 6, reference is 192.168.100.200

### Интерпретация

Если все ответы соответствуют -> **C1.12 PASSED**

В любом другом случае -> **C1.12 FAILED**
